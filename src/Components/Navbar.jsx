...
export const Navbar = () => {
    return (
        <>
            ...
            className="flex backdrop-blur-[10px] justify-between block space-x-3 shadow-xl/20 z-[50] p-4 bg-transparent border-b-2 border-gray-800 fixed max-md:fixed top-0 w-[100%] align-center max-md:dropdown max-md:w-full">
